...
QUAD_LOGGER=$(docker run -d --link "${VIRTUOSO_IMAGE}:virtuoso" -e "HTTP_SERVER_URL=http://localhost:${LOGS_SERVER_PORT:-8080}" -e "RUN_INTERVAL=60" -e "INSERT_PROCEDURE=y" -e "CUR_USER=$UID" -v $PWD/logs:/datadir jauco/virtuoso-quad-log)
