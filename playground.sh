...
echo ""
echo "The virtuoso server will be running a checkpoint every 10 minutes. This means that every 10 minutes a new log file is available for the quad logger to read."
echo "The quad logger will regenerate the logs every minute, so there will be at most a 11 minute delay before your changes are visible in the logs."
